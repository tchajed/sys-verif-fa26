...
The source of this website is on GitHub at [tchajed/sys-verif-fa26](https://github.com/tchajed/sys-verif-fa26). Feel free to submit bug reports and PRs. Your fellow students as well as students in future iterations of this class will thank you!

## Calendar

**Note:** this is still subject to some substantial changes.

The hand-written iPad notes are available at [board-notes.pdf](./slides/board-notes.pdf).
